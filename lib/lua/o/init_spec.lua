...
describe('object oriented', function()
	describe('constructor', function()
		...
		it(
			'should have the correct name as well as Object as its superclass when given only a name',
			function()
		...
		it(
			'should have the correct name and superclass when given a name and a superclass',
			function()
				local superclass_under_test = class('superclass')
				local subclass_under_test =
					class('subclass', superclass_under_test)
	...
	describe('basic class', function()
		...
		it(
			'should throw an error when given something other than a table',
			function()
				assert.error(function()
					c:implement('foobar')
				end)
	...
	describe('class extension', function()
		local c = class('some_class')
		function c.prototype:subclassed(other)
			self.prototype.child = other
		end
	...
	describe('class attributes', function()
		...
		it(
			'should be overridable by subclasses without affecting the superclass',
			function()
				b.prototype.foo = 'baz'
	...
	describe('default method', function()
		...
		it(
			'should return a human-readable string representation of the class',
			function()
	...
	describe('instances of primitives when used as instances', function()
		...
		it(
			'Object.is_instance_of(number, Object) should return false',
			function()
		...
		it(
			'Object.is_instance_of(string, Object) should return false',
			function()
		...
		it(
			'Object.is_instance_of(table, Object) should return false',
			function()
		...
		it(
			'Object.is_instance_of(function, Object) should return false',
			function()
	...
	describe('instance', function()
		describe('attributes', function()
			...
			it(
				'should be available to the instance after initialization',
				function()
			...
			it(
				'should be available to the instance after being initialized by a superclass',
				function()
	...
	describe('mixin', function()
		...
		it(
			'should have all methods except "implemented" copied to the target class',
			function()
	...
	describe('custom metamethod', function()
		...
		before_each(function()
			...
			function Vector.construct(a, x, y, z)
				a.x, a.y, a.z = x, y, z
			end
			...
			function Vector.__mul(a, b)
				if type(b) == 'number' then
					return a.class:new(a.x * b, a.y * b, a.z * b)
				end
				if type(a) == 'number' then
					return b.class:new(a * b.x, a * b.y, a * b.z)
				end
			end
	...
	describe('__index and __newindex', function()
		...
		it(
			'should not be used when the requested field exists in the class',
			function()
	...
	describe('functions', function()
		...
		before_each(function()
			...
			function Rectangle:scaleGetter()
				return self._scale
			end
		...
		it('should inherit updates from superclass', function()
			function Namespace.__index()
				return 42
			end
			assert.equal(42, r.area)

			function Rectangle.__index()
				return 24
			end
