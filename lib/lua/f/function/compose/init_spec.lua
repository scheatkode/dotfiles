...
describe('function', function()
	describe('compose()', function()
		...
		local h = function(x, y) return x + y, x + y end
		local j = function(x, y) return x * y, x * y end
		...
		it('should compose  1 n-ary function',  function() assert.same(3,                         compose(h)(1, 2)) end)
		it('should compose  2 n-ary functions', function() assert.same(9,                         compose(h, j)(1, 2)) end)
		it('should compose  3 n-ary functions', function() assert.same(18,                        compose(h, j, h)(1, 2)) end)
		it('should compose  4 n-ary functions', function() assert.same(324,                       compose(h, j, h, j)(1, 2)) end)
		it('should compose  5 n-ary functions', function() assert.same(648,                       compose(h, j, h, j, h)(1, 2)) end)
		it('should compose  6 n-ary functions', function() assert.same(419904,                    compose(h, j, h, j, h, j)(1, 2)) end)
		it('should compose  7 n-ary functions', function() assert.same(839808,                    compose(h, j, h, j, h, j, h)(1, 2)) end)
		it('should compose  8 n-ary functions', function() assert.same(705277476864,              compose(h, j, h, j, h, j, h, j)(1, 2)) end)
		it('should compose  9 n-ary functions', function() assert.same(1410554953728,             compose(h, j, h, j, h, j, h, j, h)(1, 2)) end)
		it('should compose 10 n-ary functions', function() assert.same(1989665277486600221097984, compose(h, j, h, j, h, j, h, j, h, j)(1, 2)) end)
	end)
end)
