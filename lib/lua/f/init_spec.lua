	...
	describe("iterators", function()
		...
		describe("construction", function()
			...
			it(
				...
				function()
					...
					for _, v in f.iterate(f.iterate(f.iterate(t))) do
						table.insert(r, v)
					end
			...
			it(
				...
				function()
					...
					for _, v in f.iterate(t):iterate(t):iterate(t) do
						table.insert(r, v)
					end
			...
			describe("using split", function()
				it(
					...
					function()
						...
						f.zip(f.range(10):split_p(function(x)
							return x < 5
						end)):foreach(function(x, y)
							assert.same(i, x)
							assert.same(i + 4, y)
							i = i + 1
						end)
		...
		describe("filtering", function()
			describe("using filter", function()
				...
				it("should even filter zipped iterators", function()
					...
					f.zip(f.range(0, 50, 1), f.range(0, 50, 2), f.range(0, 50, 3))
						:map(function(a, b, c)
							return a, c, b
						end)
			...
			describe("using partition", function()
				it(
					...
					function()
						...
						f.zip(f.range(10):partition(function(x, _)
							return x % 3 == 0
						end)):foreach(function(x, y)
		...
		describe("reducing", function()
			describe("using reduce", function()
				it("should accumulate the iterator", function()
					...
					assert.same(
						15,
						f.range(5):reduce(function(acc, x)
							return acc + x
						end, 0)
					)
				end)
			...
			describe("using every", function()
				it(
					...
					function()
						assert.same(
							true,
							f.iterate({ true, true, true, true }):every(function(x)
								return x
							end)
						)
					end
				...
				it(
					...
					function()
						assert.same(
							false,
							f.iterate({ true, true, true, false }):every(function(x)
								return x
							end)
						)
					end
			...
			describe("using any", function()
				it(
					...
					function()
						assert.same(
							true,
							f.iterate({ true, false, false, false }):any(function(x)
								return x
							end)
						)
					end
				...
				it(
					...
					function()
						assert.same(
							false,
							f.iterate({ false, false, false, false }):any(function(x)
								return x
							end)
						)
					end
		...
		describe("compositions", function()
			describe("using zip", function()
				...
				it("should zip partitions", function()
					...
					f.zip(f.range(15):partition(function(x)
						return x > 7
					end)):foreach(function(x, y)
						assert.same(expected[i], { x, y })
						i = i + 1
		...
		describe("builtin operator", function()
			...
			describe("arithmetic", function()
				...
				it("neg should behave as designed", function()
					...
					local result = f.iterate(t):map(f.operator.neg):totable()
			...
			describe("logical", function()
				...
				it("not (lnot) should concatenate strings", function()
					...
					local result = f.iterate(t):map(f.operator.lnot):totable()
			...
			describe("miscellaneous", function()
				...
				it(
					...
					function()
						...
						local result =
							f.iterate(t):map(f.operator.skip_key):totable()

						assert.deep_equal(u, result, true)
					end
				)
		...
		it(
			...
			function()
				...
				f.iterate(t):foreach(function(x, y)
					r[x] = y
				end)
