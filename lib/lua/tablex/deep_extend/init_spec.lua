...
describe('tablex', function()
	describe('deep_extend', function()
		...
		describe('with keeping behavior', function()
			it(
				'should extend two tables without overwriting existing elements',
				function()
					local a = { x = { a = 1, b = 2 } }
					local b = { x = { a = 2, c = { y = 3 } } }
			...
			it(
				'should extend three tables without overwriting existing elements',
				function()
					local a = { x = { a = 1, b = 2 } }
					local b = { x = { a = 2, c = { y = 3 } } }
					local c = { x = { c = 4, d = { y = 4 } } }
		...
		describe('with forcing behavior', function()
			it(
				'should extend two tables overwriting existing elements',
				function()
					local a = { x = { a = 1, b = 2 } }
					local b = { x = { a = 2, c = { y = 3 } } }
			...
			it(
				'should extend three tables overwriting existing elements',
				function()
					local a = { x = { a = 1, b = 2 } }
					local b = { x = { a = 2, c = { y = 3 } } }
					local c = { x = { c = 4, d = { y = 4 } } }
