...
------------------------------------------------------
-- status bar themes. multiple bars can be declared in each theme.
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "s", function () awful.util.spawn_with_shell("scrot -s -e 'xclip -selection clipboard -target image/png -i $f && rm $f' '/tmp/%F_%T_$wx$h.png' ") end,
