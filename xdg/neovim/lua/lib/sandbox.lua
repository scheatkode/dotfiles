...
--- may become skewed. The use of `debug.sethood` requires `jit` to be
--- disabled in case of LuaJit; the performance impact is thus, non
--- negligible.
---
--- @brief ]]
...
([[coroutine math os string table]]):gsub('%S+', function (module_name)
   base_environment[module_name] = protect_module(
