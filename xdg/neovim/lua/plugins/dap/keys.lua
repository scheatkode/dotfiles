...
local function setup ()
	...
	vim.keymap.set('n', '<leader>dQ', dap.close,             {desc = 'Close session'})
	vim.keymap.set('n', '<leader>dD', dap.disconnect,        {desc = 'Disconnect from session'})
	vim.keymap.set('n', '<leader>dq', dap.list_breakpoints,  {desc = 'Send breakpoints to quicklist'})
	vim.keymap.set('n', '<leader>du', dap.up,                {desc = 'Go up in stacktrace'})
	vim.keymap.set('n', '<leader>dd', dap.down,              {desc = 'Go down in stacktrace'})
