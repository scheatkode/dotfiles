...
return setmetatable({
	...
	lsp_document_symbols = lazy(
		"plugins.telescope.pickers.lsp_document_symbols"
	),
	lsp_workspace_symbols = lazy(
		"plugins.telescope.pickers.lsp_workspace_symbols"
	),
	lsp_workspace_dynamic_symbols = lazy(
		"plugins.telescope.pickers.lsp_workspace_dynamic_symbols"
	),

	project_or_find_files = lazy(
		"plugins.telescope.pickers.project_or_find_files"
	),
	git_current_file_commits = lazy(
		"plugins.telescope.pickers.git_current_file_commits"
	),
