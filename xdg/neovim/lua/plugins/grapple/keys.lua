return {
	setup = function()
		...
		vim.keymap.set('n', '<leader>h5', nav_file(5), {
			desc = 'Grapple to file 5',
		})
		vim.keymap.set('n', '<leader>h6', nav_file(6), {
			desc = 'Grapple to file 6',
		})
		vim.keymap.set('n', '<leader>h7', nav_file(7), {
			desc = 'Grapple to file 7',
		})
		vim.keymap.set('n', '<leader>h8', nav_file(8), {
			desc = 'Grapple to file 8',
		})
		vim.keymap.set('n', '<leader>h9', nav_file(9), {
			desc = 'Grapple to file 9',
		})
	end,
}
