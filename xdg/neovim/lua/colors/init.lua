...
local function generate_highlights(colors, config)
	local hlgroups = {
		...
		Normal       = { fg = colors.fg1, bg = not config.transparent and colors.bg or 'NONE' },
		NormalNC     = config.dim_inactive and { fg = colors.fg0, bg = colors.bg_dim } or { link = 'Normal' },
		NormalSB     = config.darken_sidebar and { fg = colors.fg0, bg = colors.bg_dim } or { link = 'Normal' },
		...
		QuickFixLine = { fg = colors.bg0, bg = colors.neutral_yellow, bold = true },
		...
		StatusLine   = { fg = colors.bg2, bg = colors.bg1 },
		...
		Function    = extend({ fg = colors.green, bold = true }, config.function_style),
		...
		-- Leap
		LeapMatch          = { fg = colors.fg,         bg     = colors.neutral_yellow, bold = true },
		LeapLabelPrimary   = { fg = colors.fg,         bg     = colors.neutral_yellow, bold = true },
