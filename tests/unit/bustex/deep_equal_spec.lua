...
describe('busted extensions', function ()
   describe('deep_equal', function ()
      ...
      it('should compare nested tables', function ()
         assert.deep_equal({1, a = {b = 1}, c = 1}, {1, a = {b = 1}, c = 1})

         assert.not_deep_equal({1, a = {b = 1}, c = 1}, {a = {b = 1}, c = 1})
         assert.not_deep_equal({1, a = {b = 1}, c = 1}, {1, a = {b = 2}, c = 1})
         assert.not_deep_equal({1, a = {1}, c = 1}, {1, a = {b = 2}, c = 1})
      end)
