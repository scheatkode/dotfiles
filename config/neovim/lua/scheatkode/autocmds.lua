...
local function setup()
	...
	local smart_close_augroup =
		vim.api.nvim_create_augroup("SmartClose", { clear = true })
	...
	local function handle_large_file()
		...
		return function()
			...
			local largefile_cleanup_augroup =
				vim.api.nvim_create_augroup("LargeFileCleanup", { clear = true })
